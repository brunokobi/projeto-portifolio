...
<form onSubmit={handleSubmit} className="flex flex-col items-center">
  ...
  onClick={() => { setLatitudei(''); setLongitudei(''); setLatitude(''); setLongitude(''); }} 
  ...
  onMouseOver={() => falar('Torre Eiffel')}
  />
</button>
...
<button onClick={() => { setLatitudei(40.6892); setLongitudei(-74.0445); }}>
  ...
  onMouseOver={() => falar('Estatua da Liberdade')}
  />
</button>
...
<button onClick={() => { setLatitudei(41.8902); setLongitudei(12.4922); }}>
  ...
  onMouseOver={() => falar('Coliseu de Roma')}
  />
</button>
...
<button onClick={() => { setLatitudei(29.9792); setLongitudei(31.1342); }}>
  ...
  onMouseOver={() => falar('Pirâmides do Egito')}
  />
</button>
...
<button onClick={() => { setLatitudei(-19.86565); setLongitudei(-40.38246); }}>
  ...
  onMouseOver={() => falar('Buda Ibiraçu')}
  />
</button>
...
<button onClick={() => { setLatitudei(-22.9519); setLongitudei(-43.2105); }}>
  ...
  onMouseOver={() => falar('Cristo Redentor')}
  />
</button>
...
<button onClick={() => { setLatitudei(27.9881); setLongitudei(86.9250); }}>
  ...
  onMouseOver={() => falar('Monte Everest')}
  />
</button>
...
<button onClick={() => { setLatitudei(19.6926); setLongitudei(-98.8456); }}>
  ...
  onMouseOver={() => falar('Pirâmide Azteca')}
  />
</button>
...
<button onClick={() => { setLatitudei(-20.329444); setLongitudei(-40.287222); }}>
  ...
  onMouseOver={() => falar('Convento da Penha')}
  />
</button>
</FormControl>
