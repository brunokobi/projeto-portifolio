...
import { Box, Flex, Grid, Text, Badge, Link, Icon, HStack } from "@chakra-ui/react";
  ...
  const badges = (
    <HStack spacing={2} flexWrap="wrap">
      <Badge
        ...
        fontFamily="heading"
        fontWeight="700"
        bg={`${article.source.color}22`}
        color={article.source.color}
        border={`1px solid ${article.source.color}44`}
        px={2}
        py="2px"
        borderRadius="full"
      >
    ...
    <Box h="100%">
      ...
      >
        {article.img && !imgErr ? (
          ...
          >
            <Text fontSize="6xl" style={{ animation: "nwsGlitch 3s ease infinite" }}>
              🤖
            </Text>
          </Box>
        )}
        ...
        <Box
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(66,201,32,0.018) 3px,rgba(66,201,32,0.018) 4px)",
          }}
        />
