...
import {
  Box, Flex, Text, Badge, Link, Icon, HStack, VStack,
...
// ── Category Card ──────────────────────────────────────────────────────────
function CategoryCard({ title, link, img, date, source, score, desc, revealDelay = 0 }: CategoryCardProps) {
  const [imgErr, setImgErr] = useState(false);
...
export { Corners, MiniCard, CategoryCard, ScrollRow, DrawerArticleRow, CategoryDrawer, CategorySection };
