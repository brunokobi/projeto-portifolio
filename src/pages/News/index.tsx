  ...
  return (
    <Box minH="100vh" w="100vw" bg="#050505" color="white">
      ...
      >
        ...
        >
          <HStack spacing={3}>
            <Text fontSize="2xl" lineHeight={1} style={{ animation: "nwsGlitch 5s ease infinite" }}>
              🛸
            </Text>
            <Box>
          ...
          <HStack spacing={2}>
            <Tooltip
              label={sortBy === "importance" ? "Ordenado por importância" : "Ordenado por data"}
              hasArrow
            >
              <Box
                as="button"
              ...
              >
                ...
                <Text as="span" ml={1}>
                  {sortBy === "importance" ? "Importância" : "Data"}
                </Text>
              </Box>
            </Tooltip>
          ...
          <HStack spacing={0} py="8px" minW="max-content" justify="space-between" w="100%">
            <HStack spacing={0}>
              {[
                ...
                {
                  label: "Linkedin",
                  to: "https://www.linkedin.com/in/brunokobi/",
                  icon: AiOutlineLinkedin,
                  external: true,
                },
                {
                  label: "Github",
                  to: "https://github.com/brunokobi",
                ...
                return item.external ? (
                  <Link key={i} href={item.to} isExternal _hover={{ textDecoration: "none" }}>
                    {inner}
                  </Link>
                ) : (
                  <Link key={i} as={RouterLink} to={item.to} _hover={{ textDecoration: "none" }}>
                    {inner}
                  </Link>
                );
              })}
            ...
            <HStack spacing={0} flexShrink={0}>
              ...
              <FilterBtn
                ...
                label="Todos"
                active={filter === "all"}
                onClick={(id) => setFilter(id as typeof filter)}
              />
              <FilterBtn
                id="world"
                label="🌎"
          ...
          >
            ...
            <Box
              ...
              css={{
                ...
                "&::-webkit-scrollbar-thumb": { background: `${GREEN}44`, borderRadius: "2px" },
              }}
            >
              {CATEGORIES.map((cat) => {
                  ...
                  <Box key={cat.id} mb={5}>
                    <HStack mb={2} spacing={2}>
                      <Box
                        ...
                        borderRadius="full"
                        bg={cat.accent}
                        style={{ boxShadow: `0 0 6px ${cat.accent}` }}
                        flexShrink={0}
                      />
          ...
          <Box px={{ base: 4, md: 8 }}>
            ...
            {(() => {
              ...
              return (
                <CategorySection
                  title="🌐 Outros"
                  desc="Outras fontes de IA ao redor do mundo."
