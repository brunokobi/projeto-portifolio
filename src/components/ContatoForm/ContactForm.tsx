    ...
    >
      ...
      <Flex direction="column" align="center" mb={6}>
        ...
        <Heading
          ...
          textAlign="center"
          letterSpacing="2px"
          textShadow={`0 0 8px ${arcadeGreen}`}
        >
          UPLINK DE CONTATO
        </Heading>
        ...
        <Flex align="center" mt={2} gap={2}>
          ...
          />
          <Text fontSize="xs" color={arcadeGreen} fontFamily="monospace">
            SYSTEM ONLINE // READY
          </Text>
        </Flex>
      </Flex>
      ...
      <form onSubmit={handleSubmit}>
        <VStack spacing={5}>
          <FormControl id="nome" isRequired>
            <FormLabel color={arcadeGreen} fontFamily="monospace" fontSize="sm">
              IDENTIFICAÇÃO (NOME)
            </FormLabel>
            <Input
              name="nome"
          ...
          <Button
            ...
            letterSpacing="2px"
            transition="all 0.3s"
            rightIcon={<Icon as={RiAliensFill} />}
            _hover={{
              bg: arcadeGreen,
              color: "black",
              boxShadow: `0 0 20px ${arcadeGreen}`,
