...
const RINGS = [
  ...
  { delay: 0.3, dur: 1.9, color: "#42c920", w: 1, blur: 6 },
  { delay: 0.45, dur: 2.2, color: "#00e5ff", w: 0.8, blur: 4 },
  { delay: 0.6, dur: 2.6, color: "#42c920", w: 0.5, blur: 2 },
];
...
const CSS = `
  ...
  @keyframes bb-text-in {
    ...
    100% { opacity:0.5; letter-spacing:0.35em; }
  }
`;
...
const BigBangLoader = () => {
  ...
  // Some quando o globo começa a aparecer (~3s de delay do GlobeBackground)
  useEffect(() => {
      ...
      {visible && (
        <motion.div
          ...
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 1, // mesmo nível do globo — substitui enquanto carrega
            overflow: "hidden",
            pointerEvents: "none",
          }}
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle at 35% 35%, #fff 0%, #00e5ff 35%, #42c920 70%, #003311 100%)",
              boxShadow: "0 0 40px 16px #00e5ff88, 0 0 80px 40px #42c92044",
              animation: "bb-orb 3s cubic-bezier(0.16,1,0.3,1) 0.08s forwards",
              opacity: 0,
            }}
          />
