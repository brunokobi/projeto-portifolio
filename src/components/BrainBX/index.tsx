const brainBX = (text: string) => {
  ...
  if (
    ...
    texto.includes("olá ") ||
    texto.includes("ola ") ||
    texto.includes("oi, tudo bem?") ||
    texto.includes("olá, tudo bem?") ||
    texto.includes("ola, tudo bem?") ||
    texto.includes("oi, tudo bem") ||
    texto.includes("olá, tudo bem") ||
    texto.includes("ola, tudo bem") ||
    texto.includes("oi, tudo bem com você?") ||
    texto.includes("olá, tudo bem com você?") ||
    texto.includes("ola, tudo bem com você?")
  ) {
    return "Olá, tudo bem?";
  } else if (
    texto.includes("tudo bem") ||
    texto.includes("como você está") ||
    texto.includes("como vai você") ||
    texto.includes("como você está se sentindo") ||
    texto.includes("tudo bem com você") ||
    texto.includes("tudo bem com você?")
  ) {
    return "Estou bem, obrigado por perguntar.";
  } else if (texto.includes("como você se chama?") || texto.includes("qual é o seu nome?")) {
    return "Meu nome é BX.";
  } else if (texto.includes("qual é sua idade?") || texto.includes("quanto anos você tem?")) {
    return "Meu nome é BX e tenho 1 ano.";
  } else if (
    texto.includes("qual é o significado da vida?") ||
    texto.includes("qual é o sentido da vida?")
  ) {
    return "A resposta para essa pergunta é 42.";
  } else if (
    texto.includes("onde você mora") ||
    texto.includes("onde você vive") ||
    texto.includes("onde você está") ||
    texto.includes("onde você se encontra") ||
    texto.includes("onde você está agora") ||
    texto.includes("onde você está neste momento") ||
    texto.includes("onde você está localizado") ||
    texto.includes("onde você está situado") ||
    texto.includes("onde você está localizado")
  ) {
    return "Até logo! Tenha um bom dia!";
  } else if (
    texto.includes("bom dia") ||
    texto.includes("bom dia, tudo bem?") ||
    texto.includes("bom dia, tudo bem") ||
    texto.includes("bom dia, tudo bem com você?") ||
    texto.includes("bom dia, tudo bem com você")
  ) {
    return "Bom dia, tudo bem?";
  } else if (texto.includes("adeus") || texto.includes("tchau")) {
    return "Até logo! Tenha um bom dia!";
    ...
    texto.includes("não sei o que fazer")
  ) {
    ...
    texto.includes("hora") ||
    texto.includes("que horas são") ||
    texto.includes("hora certa")
  ) {
    ...
    texto.includes("recomendação de filme")
  ) {
